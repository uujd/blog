	...
	<div class="container">
		...
		<div class="top-content">
			...
			<div class="main-container">
				...
				<div class="roll-btn" @click="loadBlogList">
					<button>
						<span>&lt;&gt;</span>
						<span>换一换</span>
					</button>
			...
			<div class="article-right">
				...
				<div class="template">
						...
						<div class="hot1">
							<div class="our-content">
								<div>
									...
									<a target="_blank" href="https://www.zjitc.net/" style="
												display:flex;
                    ...
                    "
									>
										<img
											src="https://img1.baidu.com/it/u=3290952983,1745986542&fm=253&fmt=auto&app=120&f=PNG?w=500&h=500"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
                      "
										...
										<img
											src="../../assets/img/微信图片_20240629194654.jpg"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
                      "
										...
										<img
											src="../../assets/img/微信图片_20240629194703.jpg"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
                      "
										...
										<img
											src="../../assets/img/微信图片_20240629195108.jpg"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
                      "
										...
										<img
											src="https://img2.baidu.com/it/u=619263617,1568068874&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1719766800&t=47542ab703540705ad83fe4204ff5dd5"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
                      "
										...
										<img
											src="https://img1.baidu.com/it/u=1956887400,2327186458&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1719766800&t=b7bf7928fafae695e87321a3411dac69"
											style="
                        width: 20px;
                        height: 20px;
                        line-height: 20px;
...
export default {
	...
	methods: {
		loadBlogList() {
  		  ...
  		  this.shuffle(this.blogList);
  		  this.mainRightBlogList = [...this.mainRightBlogList]; 
  		  this.shuffle(this.mainRightBlogList);
 				 },
 		 shuffle(array) {
